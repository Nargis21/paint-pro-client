...
const MyProfile = () => {
    ...
    const { data, isLoading, refetch } = useQuery('user', () => fetch(`https://paint-pro-server.vercel.app/user/${user.email}`, {
        method: 'GET',
        headers: {
    ...
    const handleUpdateProfile = event => {
        ...
        if (email) {
            fetch(`https://paint-pro-server.vercel.app/user/update/${email}`, {
                method: 'PUT',
                headers: {
